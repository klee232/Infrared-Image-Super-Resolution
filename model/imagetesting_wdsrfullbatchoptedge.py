...
def edge_convert(x_in, num_filters):
    ...
    nsobelx1 = tf.cast(sobel_x, tf.uint8)
    nsobely1 = tf.cast(sobel_x, tf.uint8)
    ...
    nkirsch1 = tf.cast(kirsch1, tf.uint8)
    nkirsch2 = tf.cast(kirsch2, tf.uint8)
    nkirsch3 = tf.cast(kirsch3, tf.uint8)
    nkirsch4 = tf.cast(kirsch4, tf.uint8)
    nkirsch5 = tf.cast(kirsch5, tf.uint8)
    nkirsch6 = tf.cast(kirsch6, tf.uint8)
    nkirsch7 = tf.cast(kirsch7, tf.uint8)
    nkirsch8 = tf.cast(kirsch8, tf.uint8)
    ...
    nkirsch23 = np.float32(nkirsch13)
    nkimg11 = Image.fromarray(new, 'L')
    nkimg11.save('new_kirsch1_1.png')
    ...
    max_kirsch1 = tf.math.maximum(nkirsch1, nkirsch2)
    max_kirsch2 = tf.math.maximum(max_kirsch1, nkirsch3)
    max_kirsch3 = tf.math.maximum(max_kirsch2, nkirsch4)
    max_kirsch4 = tf.math.maximum(max_kirsch3, nkirsch5)
    max_kirsch5 = tf.math.maximum(max_kirsch4, nkirsch6)
    max_kirsch6 = tf.math.maximum(max_kirsch5, nkirsch7)
    kirsch = tf.math.maximum(max_kirsch6, nkirsch8)
    ...
    nprex1 = tf.cast(pre_x, tf.uint8)
    nprey1 = tf.cast(pre_y, tf.uint8)
    ...
    prewitt = tf.cast(sqprewitt, tf.uint8)
