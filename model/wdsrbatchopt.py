...
def edge_convert(x_in, num_filters):
    ...
    ######################################
    sobel_x = keras.layers.Conv2D(num_filters, kernel_size=(3,3), padding='same', kernel_initializer=kernelInitializerx, strides=(1,1), activation='relu')(x_in)
    sobel_y = keras.layers.Conv2D(num_filters, kernel_size=(3,3), padding='same', kernel_initializer=kernelInitializery, strides=(1,1), activation='relu')(x_in)
    print("The shape of the sobelx output is:")
    print(K.shape(sobel_x))
    print("The shape of the sobely output is:")
    print(K.shape(sobel_y))
    ...
    ######################################
    kirsch1 = keras.layers.Conv2D(num_filters, kernel_size=(3,3), padding='same', kernel_initializer=kernelInitializer_kirsch1, strides=(1,1), activation='relu')(x_in)
    kirsch2 = keras.layers.Conv2D(num_filters, kernel_size=(3,3), padding='same', kernel_initializer=kernelInitializer_kirsch2, strides=(1,1), activation='relu')(x_in)
    kirsch3 = keras.layers.Conv2D(num_filters, kernel_size=(3,3), padding='same', kernel_initializer=kernelInitializer_kirsch3, strides=(1,1), activation='relu')(x_in)
    kirsch4 = keras.layers.Conv2D(num_filters, kernel_size=(3,3), padding='same', kernel_initializer=kernelInitializer_kirsch4, strides=(1,1), activation='relu')(x_in)
    kirsch5 = keras.layers.Conv2D(num_filters, kernel_size=(3,3), padding='same', kernel_initializer=kernelInitializer_kirsch5, strides=(1,1), activation='relu')(x_in)
    kirsch6 = keras.layers.Conv2D(num_filters, kernel_size=(3,3), padding='same', kernel_initializer=kernelInitializer_kirsch6, strides=(1,1), activation='relu')(x_in)
    kirsch7 = keras.layers.Conv2D(num_filters, kernel_size=(3,3), padding='same', kernel_initializer=kernelInitializer_kirsch7, strides=(1,1), activation='relu')(x_in)
    kirsch8 = keras.layers.Conv2D(num_filters, kernel_size=(3,3), padding='same', kernel_initializer=kernelInitializer_kirsch8, strides=(1,1), activation='relu')(x_in)
    print("The shape of the kirsch1 output is:")
    print(K.shape(kirsch1))
    print("The shape of the kirsch2 output is:")
    print(K.shape(kirsch2))
    print("The shape of the kirsch3 output is:")
    print(K.shape(kirsch3))
    print("The shape of the kirsch4 output is:")
    print(K.shape(kirsch4))
    print("The shape of the kirsch5 output is:")
    print(K.shape(kirsch5))
    print("The shape of the kirsch6 output is:")
    print(K.shape(kirsch6))
    print("The shape of the kirsch7 output is:")
    print(K.shape(kirsch7))
    print("The shape of the kirsch8 output is:")
    print(K.shape(kirsch8))
    ...
    print(K.shape(kirsch))
    ######################################
    # Prewitt Edge Extractor ###############
    ######################################
    pre_x = keras.layers.Conv2D(num_filters, kernel_size=(3,3), padding='same', kernel_initializer=kernelInitializer_prex, strides=(1,1), activation='relu')(x_in)
    pre_y = keras.layers.Conv2D(num_filters, kernel_size=(3,3), padding='same', kernel_initializer=kernelInitializer_prey, strides=(1,1), activation='relu')(x_in)
    print("The shape of the prex output is:")
    print(K.shape(pre_x))
    print("The shape of the prey output is:")
    print(K.shape(pre_y))
